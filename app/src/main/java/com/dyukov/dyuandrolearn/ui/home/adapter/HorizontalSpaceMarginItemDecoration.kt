...
open class HorizontalSpaceMarginItemDecoration(private val marginStart: Int, private val marginEnd: Int, private val marginInternal: Int) : RecyclerView.ItemDecoration() {
